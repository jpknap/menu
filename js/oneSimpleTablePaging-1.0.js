		...
		'oneSimpleTablePagination': function(userConfigurations) {
			...
			return this.each(function() {
				...
				function createPaginationElements() {
					...
					paginationHTML += "<a id='tablePagination_firstPage' href='javascript:;' class='btn btn-primary'>|&lt;</a>";
					paginationHTML += "<a id='tablePagination_prevPage' href='javascript:;' class='btn btn-primary'>&lt;&lt;</a>";
					paginationHTML += "Pagina";
					paginationHTML += "<input id='tablePagination_currPage' type='input' value='" + currPageNumber + "' size='1'>";
					paginationHTML += "of " + totalPages + "&nbsp;&nbsp;&nbsp;";
					paginationHTML += "<a id='tablePagination_nextPage' href='javascript:;' class='btn btn-primary'>&gt;&gt;</a>";
					paginationHTML += "<a id='tablePagination_lastPage' href='javascript:;' class='btn btn-primary'>&gt;|</a>";
					paginationHTML += "</div>";
